...
public class TrabajadorOnLine extends Trabajador {
	...
	// Attributes
	private final int tarifa_plana = 40;

	// constructor
	public TrabajadorOnLine(String nombre, String apellido, int precio_hora) {
	...
	public int calcularSueldo(int numHoras) {
		int resultado;
		resultado = super.getPrecio_hora() * numHoras + this.tarifa_plana;
		return resultado;
	};
	
	@Deprecated
	public int plus (int objetivos) {
		int resultado;
		int precio_objetivos = 10;
		resultado =objetivos * precio_objetivos;
		return resultado;
	}
